<?php
	...
	if(get_field('parallax_image_headline')) { array_push($parallax_headl_arr, get_field('parallax_image_headline')); }
	if(get_field('parallax_image_text')) { array_push($parallax_text_arr, get_field('parallax_image_text')); }
	if(get_field('parallax_image_link')) { array_push($parallax_link_arr, get_field('parallax_image_link')); }
