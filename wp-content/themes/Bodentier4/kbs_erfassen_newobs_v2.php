<?php /* Template Name: kbs_erfassen_funde_erfassen_v2 */ ?>
			...
			<div class="cell-sm-10 cell-xs-10">
				<form id="form" class="range text-left">
					...
					<script id="observationTemplate" type="text/x-kendo-template">
						...
						<div class="col-sm-6 col-xs-6 offset-top-20">
							<div class="alert alert-warning">
							<div class="form-group">
								<label for="noAttachmentsCheckbox" class="form-label form-label-outside">Ich möchte die Fundmeldung ohne Bildnachweis absenden&nbsp;</label>
								<input id="noAttachmentsCheckbox" checked class="form-control-gray" name="noAttachmentsCheckbox" type="checkbox" value="noAttachments">
							</div>
							</div>
						</div>
						<div class="col-sm-6 col-xs-6 offset-top-20">
							<div class="alert alert-success"><i class="fas fa-info-circle"></i>&nbsp;Das Hochladen von Bildern ist keine Verpflichtung, erhöht jedoch die Chancen einer erfolgreichen Validierung.</div>
						</div>
						<div class="col-sm-12 col-xs-12 offset-top-20">
							<div class="form-group">
...
<script src="<?php echo get_template_directory_uri(); ?>/02_kbs_assets/js/kbs_fundmeldungen_kendo_js/newobs_v2.js"></script>
<?php get_footer(); ?>