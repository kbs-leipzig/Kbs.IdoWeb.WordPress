<?php /* Template Name: kbs_erfassen_funde_details */ ?>
...
<script src="<?php echo get_template_directory_uri(); ?>/02_kbs_assets/js/kbs_fundmeldungen_kendo_js/adminobs_details.js"></script>
<?php get_footer(); ?>