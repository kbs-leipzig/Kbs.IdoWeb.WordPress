<?php /* Template Name: CustomPageBodentiere */ ?>
<?php get_header(); ?>
<main role="main">
<?php
while ( have_posts() ) {
              ...
              <div class="cell-md-6 cell-lg-preffix-1 cell-md-push-1">
                <div>
                  <div class="img-wrap">
					...
					<img src="<?php echo get_template_directory_uri(); ?>/images/breadcrumbs-01.jpg" width="570" height="320" alt="" class="img-responsive center-block">
					</figure>
                  </div>
                </div>
